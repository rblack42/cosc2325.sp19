...
We create special languages for use in programming a computer. These languages
...
We call the precise form of a sentence the :term:`syntax` of that sentence, and
we call the meaning of that sentence the :term:`semantics` of that sentence. 
...
taking a quick look at one of the most common ways computer languages are defined. 
...
..  figure:: images/EBNF/grammar.png
    :align: center
...
production in your grammar, but you might have more than one.

The decision on which path to take at a switch is usually easy, at least in
...
programming languages, statements always begin with a :term:`reserved word`,
chosen to help identify that statement. Words like ``if``, ``while``, and ``for``
should all be familiar to you by now. As soon as you see that word, you know
what should come next, and what rule you want to be processing in the grammar.
...
..  figure:: images/EBNF/production.png
    :align: center
...
..  figure:: images/EBNF/identifier.png
    :align: center
...
..  figure:: images/EBNF/expression.png
    :align: center
...
The simple path is just an ``identifier``, which is the name of some other
rule. Then we have a ``literal``, which is just something in quotes (either
...
diagrams those strings show up in bold.
...
:Reference: http://www.pascal-central.com/pascal-syntax.html

Back in the early 1980's I taught beginning programming classes using Wirth's
``Pascal`` Language. Pascal was so popular that Apple published a single sheet
...
their terminal (The PC had not been invented yet!):

..  image::     images/pascalposter.jpg
    :align: center
    :width: 500
